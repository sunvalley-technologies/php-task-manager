...
class TaskManager extends EventEmitter
{
     ...
     *                                  indicates both failure and success on completion or failure (i.e. returned
     *                                  promise resolves when task is concluded). Promise is rejected when task is
     *                                  failed to be submitted to queue not when a task is failed.
     */
